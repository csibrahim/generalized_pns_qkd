...
function [KL, d_logit_pEB] = pEBcost(thetaA, thetaB, dAE, k, logit_pEB)
    ...
    [Ps1, d_thetaE1] = Pabe(thetaA, thetaB, thetaE, a, b, 1); % With Eve’s interception
    Ps0 = Pabe(thetaA, thetaB, thetaE, a, b, 0); % Without Eve’s interception
    ...
    d_pEB1 = d_thetaE1{2}; % Derivative of Ps1 w.r.t pEB
