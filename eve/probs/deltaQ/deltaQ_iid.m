function [deltaQs, Qs] = deltaQ_iid(thetaA, thetaB, thetaE, both)
    ...
    [deltaQs01, Qs01] = deltaQ_iid_ab(thetaA, thetaB, thetaE, 0, 1, both);
    [deltaQs10, Qs10] = deltaQ_iid_ab(thetaA, thetaB, thetaE, 1, 0, both);
    ...
    [deltaQs1, Qs1] = deltaQ_iid_ab(thetaA, thetaB, thetaE, 1, 1, both);
...
function [deltaQs, Qs] = deltaQ_iid_ab(thetaA, thetaB, thetaE, a, b, both)
    ...
    [deltaQs0, Qs0] = deltaQ_iid_abx(thetaA, thetaB, thetaE, a, b, 0, both);
    [deltaQs1, Qs1] = deltaQ_iid_abx(thetaA, thetaB, thetaE, a, b, 1, both);
...
function [deltaQs, Qs] = deltaQ_iid_abx(thetaA, thetaB, thetaE, a, b, x, both)
