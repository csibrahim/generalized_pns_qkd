...
if(~loadData)
    ...
    % Sample and compute key rates assuming HMM
    ...
    % Sample and compute key rates assuming i.i.d.
    [thetaE_MAP_iid, samples_iid, Ks_iid, K_theory_iid] = post_process(C, params_iid);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if(~isempty(file_path))
        ...
        save(file_path, 'thetaP', 'thetaE', ...
                        'samples', 'thetaE_MAP', 'Ks', 'K_theory', ...
                        'samples_iid', 'thetaE_MAP_iid', 'Ks_iid');
    end
    ...
    fprintf('\nAssuming i.i.d. ...\n');
    printResults(thetaE_MAP_iid, thetaE);
end
...
displayHistograms(samples_iid, thetaP{3}, thetaP{4}, ...
                  'ground_truth', thetaE, ...
                  'labels', param_labels, ...
                  'FontSize', FontSize, ...
                  'FigureWidth', FigureWidth);
