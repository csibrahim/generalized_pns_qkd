function [samples, logPDFs] = sample(method, theta0, Ns, Nb, C, varR, varF, thetaF, thetaP, varargin)
    ...
    %     thetaP    - Prior parameters for the random variables in varR
    ...
    logpdf = @(phi) logPDF(phi, thetaF, varR, varF, C, thetaP);
    ...
    % Create figure for displaying progress, if enables
    if(display)
