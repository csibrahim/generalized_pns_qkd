% experiment5_eve_hmm: Simulate a session and infer the parameters of Eve
%                      assuming all other parameters are fixed.
%
...
method = 'srss';   % Sampler options: 'cmss', 'srss', or 'slice'
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % Calculate secure-key rate, gain, and QBER given true parameters
    [delta, Q, Delta] = deltaQ(thetaR, thetaF, varR, varF);
    R_theory = R(Delta, delta, Q);
    
    % Calculate secure-key rate, gain, and QBER given sample parameters
