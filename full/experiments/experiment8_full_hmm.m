...
% Pulse options
N = 1e6;    % Number of pulses in the simulation
...
param_labels_fixed = getLabels(Nl, varR_fixed, Interpreter);
param_labels_iid = getLabels(Nl, varR_iid, Interpreter);
param_labels_fixed_iid = getLabels(Nl, varR_fixed_iid, Interpreter);
